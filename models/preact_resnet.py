"""
Preactivation ResNet in PyTorch.
Reference: https://github.com/kuangliu/pytorch-cifar/blob/master/models/preact_resnet.py
       and https://pytorch.org/docs/stable/_modules/torchvision/models/resnet.html
"""
...
def preact_resnet34(num_classes=10):
...
def preact_resnet152(num_classes=10):
